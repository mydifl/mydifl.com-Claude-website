...
const expandAtma = (value) => value
  .replaceAll('ATMA—Absolute Topic Mastery Approach', 'ATMA (Absolute Topic Mastery Approach)')
  .replace(/ATMA(?!\s*\(Absolute Topic Mastery Approach\))/g, 'ATMA (Absolute Topic Mastery Approach)');

const escapeHtml = (value) => expandAtma(value)
  .replaceAll('&', '&amp;')
  .replaceAll('<', '&lt;')
  .replaceAll('>', '&gt;')
  .replaceAll('"', '&quot;');
...
<head>
  ...
  <style>
    .method-map::before{content:'ATMA (Absolute Topic Mastery Approach) + TTP'}
  ...
  <style>
    ...
    .summary strong small{display:block;margin-top:3px;font:600 9px/1.35 'DM Sans',sans-serif;letter-spacing:.2px;color:var(--gold-dark)}
    ...
    @media(max-width:650px){.table-scroll{overflow:visible;border:0;border-radius:0}.article table,.article tbody,.article tr,.article td{display:block;width:100%!important}.article thead{display:none}.article tr{overflow:hidden;margin:0 0 16px;border:1px solid var(--line);border-radius:13px;background:#fff;box-shadow:0 6px 20px rgba(13,13,13,.05)}.article td{position:relative;padding:13px 15px;border:0;border-top:1px solid var(--line);background:#fff!important}.article td:first-child{padding:13px 15px;border:0;background:#15201f!important;color:#fff;font-weight:700}.article td:nth-child(2){padding-top:35px}.article td:nth-child(3){padding-top:52px}.article td:nth-child(2)::before,.article td:nth-child(3)::before{position:absolute;left:15px;right:15px;top:10px;color:var(--gold-dark);font-size:9px;font-weight:700;line-height:1.35;letter-spacing:.5px;text-transform:uppercase}.article[lang="en"] td:nth-child(2)::before{content:'Traditional approach'}.article[lang="en"] td:nth-child(3)::before{content:'DIFL ATMA (Absolute Topic Mastery Approach)–TTP approach'}.article[lang="hi"] td:nth-child(2)::before{content:'पारंपरिक Approach'}.article[lang="hi"] td:nth-child(3)::before{content:'DIFL ATMA (Absolute Topic Mastery Approach)–TTP Approach'}}
